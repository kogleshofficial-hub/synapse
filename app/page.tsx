...
export default function Home(){
 ...
 return <main>
  ...
  <footer className="shell footer"><div><b>SYNAPSE</b><span>Turn a pile of deadlines into a plan you can actually follow.</span></div><div><span>LOCAL-FIRST</span><span>DETERMINISTIC</span><span>EXPORTABLE</span></div><small>Built independently by Koglesh Official</small></footer>
 </main>
}
